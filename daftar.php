            ...
            <div class="col-5" >
                <div class="card">
                    <div class="card-body">
                        ...
                        if ($submit=='Daftar'){
                            ...
                            if($cek==0) {
                                ...
                                echo "<div class='alert alert-success'>Pendaftaran Akun Berhasil, Silahkan Login</div>";
                                echo '<meta http-equiv="refresh" content="0.8; url=login.php">';
                            }else{
                                echo "<div class='alert alert-danger'>Maaf AKun Sudah Ada!</div>";
                    ...
                    <div class="input-group mb-3">
                            ...
                            <input type="submit" value="Daftar" class="btn btn-lg btn-info w-100 fs-6" name="submit">
                </form>
                    </div>
                    <div class="text-center">
                    <p>Sudah punya akun? <a href="login.php" class="link-danger fw-bold">Silahkan Login</a></p>
                </div>
            </div>
        </div>
    </div>
