            ...
            <div class="card">
               ...
               <h4 class="text-center"><strong>Buat Album</h4></strong>
                    ...
                    <?php
                        ...
                        if($hapus){
                            echo "<div class='alert alert-success'>Berhasil Menghapus Album</div>";
                            echo '<meta http-equiv="refresh" content="0.8; url=?url=album">';
                        }else{
                            echo "<div class='alert alert-danger'>Gagal Menghapus Album!</div>";
                            echo '<meta http-equiv="refresh" content="0.8; url=?url=album">';
                        }
                    }
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="?url=kategori&&albumid=<?= $album['albumid'] ?>" class="btn btn-sm btn-success my-2">Lihat Foto</a>
                        </td>
                    </tr>
